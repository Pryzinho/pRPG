        ...
        if (args[0].equalsIgnoreCase("character")) {
            ...
            if (args[2].equalsIgnoreCase("stats")) {
                ...
                if (args[3].equalsIgnoreCase("add")) {
                    ...
                    switch (args[4]) {
                        case "strength":
                            ch.getClazz().getStats().addStrength(points);
                            ...
                            return true;
                        case "resistance":
                            ch.getClazz().getStats().addResistance(points);
                ...
                if (args[3].equalsIgnoreCase("dec") || args[3].equalsIgnoreCase("rem")) {
                    ...
                    switch (args[4]) {
                        case "strength":
                            ch.getClazz().getStats().remStrength(points);
                            ...
                            return true;
                        case "resistance":
                            ch.getClazz().getStats().remResistance(points);
                ...
                if (args[3].equalsIgnoreCase("set")) {
                    ...
                    switch (args[4]) {
                        case "strength":
                            ch.getClazz().getStats().setStrength(points);
                            ...
                            return true;
                        case "resistance":
                            ch.getClazz().getStats().setResistance(points);
            ...
            if (args[2].equalsIgnoreCase("info")) {
                ...
                Stats stats = ch.getClazz().getStats();
